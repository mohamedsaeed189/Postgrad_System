...
namespace Milestone
{
    public partial class AdminViewAllThesesAndAdminviewOnGoingTheses : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand thesescountproc = new SqlCommand("adminViewOnGoingTheses", conn);
            thesescountproc.CommandType = CommandType.StoredProcedure;
            SqlParameter thesesCount = thesescountproc.Parameters.Add("@thesesCount", SqlDbType.Int);

            thesesCount.Direction = ParameterDirection.Output;

            conn.Open();
            thesescountproc.ExecuteNonQuery();
            conn.Close();


            Label thesiscount = new Label();
            thesiscount.Text = "ON Going Thesis Count:  " + thesesCount.Value;

            SqlCommand thesesproc = new SqlCommand("AdminViewAllTheses", conn);
            thesesproc.CommandType = CommandType.StoredProcedure;
            ...
            resultString.Text = separator + separator;
            ...
            SqlDataReader rdr = thesesproc.ExecuteReader(CommandBehavior.CloseConnection);
